  ...
  static toResponse(program: ProgramWithCategory): ProgramResponseDto {
    return {
      ...
      indicators: program.indicators ? program.indicators.map((ind) => ({
        ...
        usulanPerbaikanURL: ind.usulanPerbaikanURL ?? null,
        usulanBahanHabisURL: ind.usulanBahanHabisURL ?? null,
        usulanPeralatanURL: ind.usulanPeralatanURL ?? null,
        usulanPelatihanURL: ind.usulanPelatihanURL ?? null,
        usulanMeubelairURL: ind.usulanMeubelairURL ?? null,
